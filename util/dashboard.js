...
module.exports = (client) => {
  ...
  app.get("/yonetim", checkAuth, (req, res) => {
...
db.delete(`toplamüyenick_${guild.id}`)
   db.delete(`rekorsayınick_${guild.id}`)
db.delete(`aktifsayınick_${guild.id}`)
db.delete(`tümbotnick_${guild.id}`)
db.delete(`sessayınick_${guild.id}`)
db.delete(`sonüyenick_${guild.id}`)
